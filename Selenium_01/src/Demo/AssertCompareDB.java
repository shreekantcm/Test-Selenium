...
public class AssertCompareDB {
	...
	public static void main(String[] args) {
		...
		public ArrayList<String> fbLogin(){
	  ...
	  public static ArrayList<String> DB_Test(){
			...
			try{
				...
				while(result.next()){
					...
					//System.out.println("DB Query O/P: " +Month_Name);
					//Month_Name = System.out.print(result.getString(2)); 
				}
				System.out.println("DB Query O/P: " + monthName);
	//			Assert.assertEquals(monthName, Month_List, "List Same");
				return monthName;
			}
			catch(Exception e){
			...
			//	Assert.assertEquals(Month_Name, Month_List);
